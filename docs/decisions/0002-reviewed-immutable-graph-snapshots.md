...
and an explicit human approval decision. The snapshot includes a SHA-256 digest
...
- A model draft cannot directly change the graph.
- The reviewer, not Luna, assigns dependency strength, substitutability, and
  confidence as documented scenario assumptions.
